#ifndef NETWORKIT_IO_MATRIX_MARKET_PARSER_HPP_
#define NETWORKIT_IO_MATRIX_MARKET_PARSER_HPP_
 ...
 */
class MatrixMarketParser final {
...
public:
    ...
    MatrixMarketParser(const std::string &path);
...
#endif // NETWORKIT_IO_MATRIX_MARKET_PARSER_HPP_
