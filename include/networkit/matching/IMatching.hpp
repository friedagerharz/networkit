#ifndef NETWORKIT_MATCHING_I_MATCHING_HPP_
#define NETWORKIT_MATCHING_I_MATCHING_HPP_
...
public:
     ...
     * @param b b value
     */
    IMatching(count z = 0, count b = 1);

    virtual ~IMatching() = default;

    /**
     * Checks whether this is a proper matching.
     *
     * @param G
     * @return bool
     */
...
#endif // NETWORKIT_MATCHING_I_MATCHING_HPP_
